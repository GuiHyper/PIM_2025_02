...
def abrir_tela_salas(content_frame):
    ...
    global sala_id_selecionada, entry_nome_sala, entry_capacidade_sala, tree_salas, tree_alunos_sala
    ...
    tree_salas = ttk.Treeview(salas_frame, columns=("ID", "Nome", "Capacidade"), show="headings", height=15)
